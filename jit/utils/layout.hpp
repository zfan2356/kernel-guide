...
// Tensor utils
template <int N> static auto get_shape(const torch::Tensor& t) {
...
// Recipe
static std::tuple<int, int, int> get_default_recipe(const torch::ScalarType& sfa_dtype,
...
// SF layouts
static torch::Tensor check_sf_layout(const torch::Tensor& sf, const int& mn, const int& k, const int& gran_mn,
